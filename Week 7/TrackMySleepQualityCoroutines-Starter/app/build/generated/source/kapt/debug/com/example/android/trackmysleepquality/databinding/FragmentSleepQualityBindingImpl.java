...
public class FragmentSleepQualityBindingImpl extends FragmentSleepQualityBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.quality_zero_image, 2);
        sViewsWithIds.put(R.id.quality_one_image, 3);
        sViewsWithIds.put(R.id.quality_two_image, 4);
        sViewsWithIds.put(R.id.quality_three_image, 5);
        sViewsWithIds.put(R.id.quality_four_image, 6);
        sViewsWithIds.put(R.id.quality_five_image, 7);
    }
    // views
    @NonNull
